...
public enum Permissao {
	...
	IMOVELCASA_ACESSAR("IMOVELCASA_ACESSAR", "  - Acessar"),
	IMOVELCASA_NOVO("IMOVELCASA_NOVO", "Imovel Casa - Novo"),
	IMOVELCASA_EDITAR("IMOVELCASA_EDITAR", "Imovel Casa - Editar"),
	IMOVELCASA_EXCLUIR("IMOVELCASA_EXCLUIR", "Imovel Casa - Excluir"),
	
	IMOVELAPTO_ACESSAR("IMOVELAPTO_ACESSAR", "  - Acessar"),
	IMOVELAPTO_NOVO("IMOVELAPTO_NOVO", "Imovel Apto - Novo"),
	IMOVELAPTO_EDITAR("IMOVELAPTO_EDITAR", "Imove Apto - Editar"),
	IMOVELAPTO_EXCLUIR("IMOVELAPTO_EXCLUIR", "Imove Apto - Excluir"),

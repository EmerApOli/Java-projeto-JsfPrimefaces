...
public class TituloBeanView extends BeanManagedViewAbstract {
	...
	public void saveNotReturn() throws Exception {
			if (validarCampoObrigatorio(objetoSelecionado)) {
				validarEntidadeBaixa();
				 valortotaltitulo() ; //aqui chamei o metdod que atribui valor ao valor total
				list.clear();
				listBaixar.clear();
	...
	private void valortotaltitulo() {
		BigDecimal valor_titulo;
		//BigDecimal valor_baixa;
		BigDecimal valor_total;
		
		valor_titulo =  objetoSelecionado.getTit_valor();
		// valor_baixa =  objetoSelecionado.getTit_valorbaixa();
		valor_total = valor_titulo.add(valor_titulo);
		objetoSelecionado.setTit_valortotal(new BigDecimal(valor_total.toBigInteger()));
	...
	public String efetuarBaixa() throws Exception {
			...
			//objetoSelecionado.setTit_valortotal(new BigDecimal ("1.23"));
			//valottotaltitulo() ;
